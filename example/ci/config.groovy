...
return [
    ...
    FLUTTER_DOCKER_ARGS : '-v example-pub-cache:/root/.pub-cache -v example-gradle-cache:/root/.gradle/caches', // unused in native mode

    // ================================================================
    // Android signing — Jenkins credential IDs
    // ================================================================
    CRED_ANDROID_KEYSTORE      : 'example-android-keystore',   // .jks / .keystore file credential
    CRED_ANDROID_KEY_PROPERTIES: 'example-key-properties',     // key.properties file credential
    ...
    // ================================================================
    CRED_IOS_CERT_STAGING             : 'example-ios-distribution-cert',          // .p12 file credential
    CRED_IOS_CERT_PASSWORD_STAGING    : 'example-ios-distribution-cert-password', // string credential
    CRED_IOS_PROFILE_STAGING          : 'example-ios-adhoc-profile',         // .mobileprovision file credential (Ad Hoc)
    CRED_IOS_PROFILE_STAGING_TESTFLIGHT: 'example-ios-appstore-staging-profile',     // .mobileprovision file credential (App Store, used only if IOS_STAGING_DISTRIBUTION is 'testflight' or 'both')
    ...
    CRED_IOS_CERT_PRODUCTION          : 'example-ios-distribution-cert',          // .p12 file credential
    CRED_IOS_CERT_PASSWORD_PRODUCTION : 'example-ios-distribution-cert-password', // string credential
    CRED_IOS_PROFILE_PRODUCTION       : 'example-ios-appstore-profile',       // .mobileprovision file credential
    ...
    // project's config.groovy, not derived from example.
    // ================================================================
    ...
    BUILDFLIGHT_APK_FILENAME: 'example.apk', // .apk — what testers see in the OTA listing
    BUILDFLIGHT_IPA_FILENAME: 'example.ipa', // .ipa
    ...
    // ================================================================
    IOS_PROVISIONING_PROFILE_FILENAME_STAGING           : 'example_Ad_Hoc_Staging.mobileprovision',       // .mobileprovision (Ad Hoc)
    IOS_PROVISIONING_PROFILE_FILENAME_STAGING_TESTFLIGHT: 'example_Appstore_Staging.mobileprovision',    // .mobileprovision (App Store, used if IOS_STAGING_DISTRIBUTION is 'testflight' or 'both')

    IOS_PROVISIONING_PROFILE_FILENAME_PRODUCTION        : 'example_Appstore_Production.mobileprovision', // .mobileprovision
