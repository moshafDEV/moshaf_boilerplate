...
**example** is a Flutter app generated from the [`moshaf_boilerplate`](https://pub.dev/packages/moshaf_boilerplate) template — Clean Architecture, BLoC state management, `go_router` navigation, and dev/prod flavors set up out of the box.
